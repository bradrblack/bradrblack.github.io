        ...
        const pgButton = document.getElementById('pg-button');
        ...
        const fileSystem = {
            ...
            '/bin': ['cat','more', 'ps', 'clear', 'date', 'echo', 'exit', 'fortune', 'ls', 'pwd', 'rot13', 'uname', 'uptime', 'whoami', 'cd'],
...
'README.txt': `Merry Christmas and Happy New Year!!`,
        ...
        // Autocomplete data
        const availableCommands = ['cat', 'more', 'clear', 'ps', 'date', 'echo', 'exit', 'fortune', 'ls', 'pwd', 'rot13', 'uname', 'uptime', 'whoami', 'cd'];
        ...
        // Handle pg button click
        pgButton.addEventListener('click', () => {
            window.open("https://bradster.ca/index-pg.html");
        });
